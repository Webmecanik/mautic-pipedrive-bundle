...
class CredentialsTest extends \PHPUnit\Framework\TestCase
{
    public function testGetters(): void
    {
        ...
        $this->assertEquals('https://oauth.pipedrive.com/oauth/authorize', $credentials->getAuthorizationUrl());
        $this->assertEquals('https://oauth.pipedrive.com/oauth/token', $credentials->getTokenUrl());
